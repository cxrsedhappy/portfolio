        ...
        <div className="w-full md:w-1/2 p-6 overflow-y-auto flex items-center">
          <div className="space-y-7 max-w-md mx-auto">
            ...
            <div className="border-b border-gray-700">
              ...
              <div className={`overflow-hidden transition-all duration-800 ${openSections.about ? 'max-h-96' : 'max-h-0'}`}>
                <div className="pb-4 pt-0 space-y-2">
                  <p className={"mb-4"}>Feel free to contact me using the form, or directly via email or social media.</p>

                  <p className="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                    </svg>
                    <a href="mailto:staspashkov2003@main.ru" className="text-blue-400 hover:text-blue-300 transition-colors">staspashkov2003@main.ru</a>
                  </p>
                  ...
                  <p className="flex items-center gap-2">
                    ...
                    <Link to="https://t.me/daixe" rel="noopener noreferrer" target="_blank"  className="text-blue-400 hover:text-blue-300 transition-colors">Telegram</Link>
                  </p>

                  <p className="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-400" viewBox="0 0 127.14 96.36" fill="currentColor">
                    ...
                    <Link to="https://discord.com/users/username" rel="noopener noreferrer" target="_blank" className="text-blue-400 hover:text-blue-300 transition-colors">Discord</Link>
                  </p>
            ...
            <div className="border-b border-gray-700">
              ...
              <div className={`overflow-hidden transition-all duration-800 ${openSections.location ? 'max-h-96' : 'max-h-0'}`}>
            ...
            <div className="border-b border-gray-700">
              ...
              <div className={`overflow-hidden transition-all duration-800 ${openSections.hours ? 'max-h-96' : 'max-h-0'}`}>
            ...
            <div className="flex justify-center space-x-4 pt-4">
              <a href="https://github.com/cxrsedhappy" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded transition-colors duration-300">
                Send Message
              </button>
            </form>
