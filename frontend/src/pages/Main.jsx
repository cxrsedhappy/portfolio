...
export default function Main() {
  ...
  const renderSection = (section, title, content) => (
    <div className="border-b border-gray-400">
      <h3 className="flex">
        ...
        >
          ...
          <svg
            ...
            className={`h-4 w-4 shrink-0 transition-transform duration-200 ${openSections[section] ? 'rotate-180' : ''}`}
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
      ...
      <div
        className={`overflow-hidden duration-800 ${openSections[section] ? '' : 'max-h-0'}`}
        style={{ maxHeight: openSections[section] ? refs[section].current?.scrollHeight : '0' }}
        ref={refs[section]}
      >
